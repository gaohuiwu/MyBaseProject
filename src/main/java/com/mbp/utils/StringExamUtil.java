...
/**
 * FileName:StringExamUtil
 * Author:  ghw06
 * Date:    2018/2/11 11:38
 * Description: String字符串的操作工具类
 */
public class StringExamUtil {
	 ...
	 * 字符串前补零
	 *
	 * @param num 需要返回的字符串为几位
	 * @param str 传入的需要补零的字符串
	 * @return
	 */
	public static String polishByZero(int num, String str) {
		return String.format("%0" + num + "d", Integer.parseInt(str) + 1);
	}
}
